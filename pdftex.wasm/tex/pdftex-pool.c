...
static const char *poolfilearr[] = {
  ...
  "nolig",
  "\\letterspacefont",
  "font has zero em size (\\fontdimen6)",
  "ls",
  "FONT",
  "\\pdfcopyfont",
  ...
  "too small image resolution ignored",
  "mediabox",
  "cropbox",
  "bleedbox",
  "trimbox",
  ...
  "action type missing",
  "struct",
  "only GoTo action can be used with `struct'",
  "name",
  ...
  ") ",
  "\\pdfdest",
  "struct identifier must be positive",
  "xyz",
  "zoom",
  "fitbh",
  "fitbv",
